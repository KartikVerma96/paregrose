...
const SocialProof = () => {
  ...
  return (
    <section className="w-full py-16 sm:py-20 px-4 bg-gradient-to-b from-white via-green-50/30 to-white">
      <div className="max-w-6xl mx-auto">
        ...
        >
          <div className="inline-block mb-3">
            <span className="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-green-100 to-emerald-100 
                           rounded-full text-green-700 text-xs sm:text-sm font-bold uppercase tracking-wider border-2 border-green-200">
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold mb-4 bg-gradient-to-r from-green-600 via-emerald-600 to-green-600 bg-clip-text text-transparent">
            Loved By Thousands
          </h2>
