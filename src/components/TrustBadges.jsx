...
const TrustBadges = () => {
  ...
  return (
    <section className="w-full py-16 sm:py-20 px-4 bg-gradient-to-b from-white via-blue-50/30 to-white">
      <div className="max-w-6xl mx-auto">
        ...
        >
          <div className="inline-block mb-3">
            <span className="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-blue-100 to-cyan-100 
                           rounded-full text-blue-700 text-xs sm:text-sm font-bold uppercase tracking-wider border-2 border-blue-200">
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold mb-4 bg-gradient-to-r from-blue-600 via-cyan-600 to-blue-600 bg-clip-text text-transparent">
